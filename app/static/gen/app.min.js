...
var rows=c.data.events.map(function(event){return m('tr',[m('td',{'class':'fade summary'},jrvs.truncate(event.summary,19)),m('td.start',event.startdate.format('DD. MM HH:mm'))]);});return[m('p.fade','Creativia Scenen:'),m('h1',c.data.today?c.data.today.startdate.format('HH:mm'):'--:--'),m('h2',c.data.today?jrvs.truncate(c.data.today.summary,20):'Ingenting skjer!'),m('table',rows),m('p',{'class':'fade updated-at'},'Sist oppdatert: '+
